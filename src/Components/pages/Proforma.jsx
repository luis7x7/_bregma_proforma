...
import Parte_1 from "../p-inicio/inicio.jsx";
import Parte_2 from "../p-bt-servicio/seccion-servicio.jsx";
import Estadistica1 from "../p-graficos/cont-graficos.jsx";
import Card from "../p-lista-proforma/card.jsx";
      ...
      <div className="container-jn-2">
          ...
          <div className="conteiner-base-chris">
            ...
            <div className="proformaDetails">
              ...
              {selectedProformaData && (
                <div>
                  <h3 className="tl-dt">Detalle de la Solicitud</h3>
                  <main>
                    <article>
                      <p className=" sub-tl">Solicitud:</p>
                      <input
